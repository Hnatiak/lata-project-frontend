import { GeneralContainer, ContainerDiv, ContainerA, ContainerSpan, ContainerP, MiddleContainer, Svg } from './Container.styled';
        ...
        <GeneralContainer>
          <MiddleContainer>
            <ContainerDiv style={{ flex: 1 }}>
                <Svg icon={faPrint} />
              <h6><ContainerSpan>Повноколірний офсетний друк форматом B1</ContainerSpan></h6>
            ...
            <ContainerDiv style={{ flex: 1 }}>
                <Svg icon={faDroplet} />
                {/* <Animation> */}
                    <h6><ContainerSpan>Лакування ультрафіолетовим лаком форматом B1</ContainerSpan></h6>
            ...
            <ContainerDiv style={{ flex: 1 }}>
              ...
              <h6><ContainerSpan>Оперативне виконання Ваших замовлень</ContainerSpan></h6>
            ...
            <ContainerDiv style={{ flex: 1 }}>
              ...
              <h6><ContainerSpan>Доставка продукції до компанії замовника</ContainerSpan></h6>
